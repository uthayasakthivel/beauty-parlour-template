    ...
    <section className="bg-white py-28">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mb-16 grid gap-6 md:grid-cols-3">
          {contactInfo.map((item) => {
            ...
            return (
              <div
                key={item.id}
                className="rounded-3xl border border-teal-100 bg-teal-50 p-8 text-center shadow-sm transition hover:-translate-y-2 hover:shadow-lg"
              >
                <Icon className="mx-auto mb-4 text-4xl text-teal-600" />
        ...
        <div className="grid gap-10 lg:grid-cols-2">
          {/* Form */}
          <div className="rounded-3xl border border-teal-100 p-8 shadow-lg">
            ...
            <form className="space-y-5">
              <input
                ...
                className="w-full rounded-xl border border-gray-300 p-4 focus:border-teal-500 focus:outline-none"
              />
          ...
          <div className="rounded-3xl bg-teal-600 p-8 text-white shadow-lg">
            <h3 className="mb-6 text-3xl heading-font">Opening Hours</h3>

            <div className="space-y-4 text-lg">
              <div className="flex justify-between border-b border-teal-400 pb-3">
