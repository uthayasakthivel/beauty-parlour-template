    ...
    <section className="bg-[#FFF8FA] py-24">
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-14 text-center">
          <p className="font-semibold uppercase tracking-[5px] text-teal-600">
            Our Purpose
          </p>
        ...
        <div className="grid gap-8 md:grid-cols-2">
          {cards.map((card) => {
            ...
            return (
              <div
                key={card.title}
                className="rounded-3xl border border-teal-100 bg-white p-10 shadow-lg transition duration-300 hover:-translate-y-2 hover:shadow-2xl"
              >
                <div className="mb-6 inline-flex rounded-full bg-teal-100 p-5">
